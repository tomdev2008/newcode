...
public class CommonController {
	...
	public Map<String, String> publicKey(HttpServletRequest request) {
		...
		localHashMap.put("modulus", Base64.encodeBase64String(localRSAPublicKey
				.getModulus().toByteArray()));
		localHashMap.put("exponent", Base64
				.encodeBase64String(localRSAPublicKey.getPublicExponent()
						.toByteArray()));
		return localHashMap;
	}
	...
	public void image(String captchaId, HttpServletRequest request,
		...
		try {
			...
			BufferedImage localBufferedImage = this.IIIlllII
