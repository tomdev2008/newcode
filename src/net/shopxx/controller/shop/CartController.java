...
public class CartController extends BaseController {
	...
	public Message add(Long id, Integer quantity, HttpServletRequest request,
		...
		if (localMember == null) {
			CookieUtils.addCookie(request, response, "cartId", localCart
					.getId().toString(), Integer.valueOf(604800));
			CookieUtils.addCookie(request, response, "cartKey",
					localCart.getKey(), Integer.valueOf(604800));
		}
		return Message.success("shop.cart.addSuccess",
				new Object[] { Integer.valueOf(localCart.getQuantity()),
						IIIllIlI(localCart.getAmount(), true, false) });
	}
