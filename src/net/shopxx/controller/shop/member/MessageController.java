...
public class MessageController extends BaseController {
	...
	public boolean checkUsername(String username) {
		return (!StringUtils.equalsIgnoreCase(username,
				this.IIIllllI.getCurrentUsername()))
				&& (this.IIIllllI.usernameExists(username));
	}
	...
	public String send(Long draftMessageId, Model model) {
		net.shopxx.entity.Message localMessage = (net.shopxx.entity.Message) this.IIIlllIl
				.find(draftMessageId);
		if ((localMessage != null)
				&& (localMessage.getIsDraft().booleanValue())
				&& (localMessage.getSender() == this.IIIllllI.getCurrent()))
	...
	public String send(Long draftMessageId, String username, String title,
		...
		if (!IIIllIlI(net.shopxx.entity.Message.class, "content", content,
				new Class[0]))
			return "/shop/common/error";
		Member localMember1 = this.IIIllllI.getCurrent();
		net.shopxx.entity.Message localMessage1 = (net.shopxx.entity.Message) this.IIIlllIl
				.find(draftMessageId);
		...
		if (isDraft.booleanValue()) {
			IIIllIlI(redirectAttributes, net.shopxx.Message.success(
	...
	public String list(Integer pageNumber, Model model) {
		...
		model.addAttribute("page",
				this.IIIlllIl.findPage(localMember, localPageable));
	...
	public String draft(Integer pageNumber, Model model) {
		...
		Member localMember = this.IIIllllI.getCurrent();
		model.addAttribute("page",
				this.IIIlllIl.findDraftPage(localMember, localPageable));
