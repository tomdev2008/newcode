...
public class MemberController extends BaseController {
	...
	public String index(Integer pageNumber, ModelMap model) {
		...
		model.addAttribute("waitingPaymentOrderCount",
				this.IIIlllll.waitingPaymentCount(localMember));
		model.addAttribute("waitingShippingOrderCount",
				this.IIIlllll.waitingShippingCount(localMember));
		model.addAttribute("messageCount",
				this.IIlIIIIl.count(localMember, Boolean.valueOf(false)));
		model.addAttribute(
				"couponCodeCount",
				this.IIlIIIII.count(null, localMember, null,
						Boolean.valueOf(false), Boolean.valueOf(false)));
		model.addAttribute("favoriteCount", this.IIlIIIlI.count(localMember,
				null, null, null, null, null, null));
		model.addAttribute("productNotifyCount",
				this.IIlIIIll.count(localMember, null, null, null));
		model.addAttribute("reviewCount",
				this.IIlIIlII.count(localMember, null, null, null));
		model.addAttribute("consultationCount",
				this.IIlIIlIl.count(localMember, null, null));
		model.addAttribute("newOrders", this.IIIlllll.findList(localMember,
