...
public class PasswordController extends BaseController {
	...
	public Message find(String captchaId, String captcha, String username,
			String email) {
		if (!this.IIIlllIl.isValid(Setting.CaptchaType.findPassword, captchaId,
				captcha))
		...
		this.IIIlllll.sendFindPasswordMail(localMember.getEmail(),
	...
	public Message reset(String captchaId, String captcha, String username,
		...
		if (!this.IIIlllIl.isValid(Setting.CaptchaType.resetPassword,
				captchaId, captcha))
			return Message.error("shop.captcha.invalid", new Object[0]);
		Member localMember = this.IIIllllI.findByUsername(username);
		if (localMember == null)
			return IIIllIll;
		if (!IIIllIlI(Member.class, "password", newPassword,
