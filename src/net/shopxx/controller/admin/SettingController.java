...
public class SettingController extends BaseController {
	...
	public Message mailTest(String smtpFromMail, String smtpHost,
		...
		try {
			if ((!IIIllIlI(Setting.class, "smtpFromMail", smtpFromMail,
					new Class[0]))
					|| (!IIIllIlI(Setting.class, "smtpHost", smtpHost,
							new Class[0]))
					|| (!IIIllIlI(Setting.class, "smtpPort", smtpPort,
							new Class[0]))
					|| (!IIIllIlI(Setting.class, "smtpUsername", smtpUsername,
							new Class[0])))
				return IIIllIll;
	...
	public String update(Setting setting, MultipartFile watermarkImageFile,
		...
		if ((watermarkImageFile != null) && (!watermarkImageFile.isEmpty())) {
			...
			localObject1 = this.fileService.uploadLocal(FileInfoFileType.image,
					watermarkImageFile);
