...
public class CommonController implements ServletContextAware {
	...
	public String index(ModelMap model) {
		...
		model.addAttribute("servletVersion", this.IIlIIlII.getMajorVersion()
				+ "." + this.IIlIIlII.getMinorVersion());
		model.addAttribute("waitingPaymentOrderCount",
				this.IIlIIIII.waitingPaymentCount(null));
		model.addAttribute("waitingShippingOrderCount",
				this.IIlIIIII.waitingShippingCount(null));
		model.addAttribute("marketableProductCount", this.IIlIIIIl.count(null,
				Boolean.valueOf(true), null, null, Boolean.valueOf(false),
				null, null));
		model.addAttribute("notMarketableProductCount", this.IIlIIIIl.count(
				null, Boolean.valueOf(false), null, null,
				Boolean.valueOf(false), null, null));
		model.addAttribute(
				"stockAlertProductCount",
				this.IIlIIIIl.count(null, null, null, null,
		...
		model.addAttribute("unreadMessageCount",
				this.IIlIIIll.count(null, Boolean.valueOf(false)));
	...
	public Map<Long, String> area(Long parentId) {
		...
		return (Map<Long, String>) localHashMap;
	}
	...
	public void image(String captchaId, HttpServletRequest request,
		...
		try {
			...
			BufferedImage localBufferedImage = this.IIIlllll
