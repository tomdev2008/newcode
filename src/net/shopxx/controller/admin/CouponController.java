...
public class CouponController extends BaseController {
	...
	public String build(Long id, ModelMap model) {
		...
		model.addAttribute("totalCount", this.couponCodeService.count(
				localCoupon, null, null, null, null));
		model.addAttribute("usedCount", this.couponCodeService.count(
				localCoupon, null, null, null, Boolean.valueOf(true)));
	...
	public ModelAndView download(Long id, Integer count, ModelMap model) {
		...
		arrayOfString[0] = (IIIllIlI("admin.coupon.type", new Object[0]) + ": " + localCoupon
				.getName());
		arrayOfString[1] = (IIIllIlI("admin.coupon.count", new Object[0])
				+ ": " + count);
		arrayOfString[2] = (IIIllIlI("admin.coupon.operator", new Object[0])
				+ ": " + this.adminService.getCurrentUsername());
		arrayOfString[3] = (IIIllIlI("admin.coupon.date", new Object[0]) + ": " + new SimpleDateFormat(
				"yyyy-MM-dd HH:mm:ss").format(new Date()));
		return new ModelAndView(new ExcelView(str, null,
				new String[] { "code" }, new String[] { IIIllIlI(
						"admin.coupon.title", new Object[0]) }, null, null,
				localList, arrayOfString), model);
	}
}
