...
public class ProductController extends BaseController {
	...
	public String save(Product product, Long productCategoryId, Long brandId,
		...
		while (((Iterator) localObject3).hasNext()) {
			...
			localObject4 = request.getParameter("memberPrice_"
					+ ((MemberRank) localObject2).getId());
			if ((StringUtils.isNotEmpty((String) localObject4))
					&& (new BigDecimal((String) localObject4)
							.compareTo(new BigDecimal(0)) >= 0))
				product.getMemberPrice().put(localObject2,
						new BigDecimal((String) localObject4));
			else
		...
		localObject3 = product.getProductCategory().getParameterGroups()
				.iterator();
		Object localObject5;
		Object localObject6;
		while (((Iterator) localObject3).hasNext()) {
			localObject2 = (ParameterGroup) ((Iterator) localObject3).next();
			localObject5 = ((ParameterGroup) localObject2).getParameters()
					.iterator();
			while (((Iterator) localObject5).hasNext()) {
				localObject4 = (Parameter) ((Iterator) localObject5).next();
				localObject6 = request.getParameter("parameter_"
						+ ((Parameter) localObject4).getId());
		...
		while (((Iterator) localObject3).hasNext()) {
			...
			localObject4 = request.getParameter("attribute_"
					+ ((Attribute) localObject2).getId());
			if (StringUtils.isNotEmpty((String) localObject4))
				product.setAttributeValue((Attribute) localObject2,
						(String) localObject4);
			else
		...
		if ((specificationIds != null) && (specificationIds.length > 0)) {
			for (int i = 0; i < specificationIds.length; i++) {
				localObject5 = (Specification) this.specificationService
						.find(specificationIds[i]);
				localObject6 = request.getParameterValues("specification_"
						+ ((Specification) localObject5).getId());
	...
	public String update(Product product, Long productCategoryId, Long brandId,
		...
		while (((Iterator) localObject1).hasNext()) {
			...
			if ((localObject2 == null)
					|| (((ProductImage) localObject2).isEmpty())) {
				((Iterator) localObject1).remove();
			} else {
				if ((((ProductImage) localObject2).getFile() == null)
						|| (((ProductImage) localObject2).getFile().isEmpty())
						|| (this.fileService.isValid(FileInfo.FileType.image,
								((ProductImage) localObject2).getFile())))
					continue;
				IIIllIlI(redirectAttributes,
						Message.error("admin.upload.invalid", new Object[0]));
		...
		if ((StringUtils.isNotEmpty(product.getSn()))
				&& (!this.productService.snUnique(
						((Product) localObject1).getSn(), product.getSn())))
			return "/admin/common/error";
		if (product.getMarketPrice() == null) {
		...
		while (((Iterator) localObject4).hasNext()) {
			...
			localObject5 = request.getParameter("memberPrice_"
					+ ((MemberRank) localObject3).getId());
			if ((StringUtils.isNotEmpty((String) localObject5))
					&& (new BigDecimal((String) localObject5)
							.compareTo(new BigDecimal(0)) >= 0))
				product.getMemberPrice().put(localObject3,
						new BigDecimal((String) localObject5));
			else
		...
		if ((product.getImage() == null) && (product.getThumbnail() != null))
			product.setImage(product.getThumbnail());
		localObject4 = product.getProductCategory().getParameterGroups()
				.iterator();
		Object localObject6;
		Object localObject7;
		while (((Iterator) localObject4).hasNext()) {
			localObject3 = (ParameterGroup) ((Iterator) localObject4).next();
			localObject6 = ((ParameterGroup) localObject3).getParameters()
					.iterator();
			while (((Iterator) localObject6).hasNext()) {
				localObject5 = (Parameter) ((Iterator) localObject6).next();
				localObject7 = request.getParameter("parameter_"
						+ ((Parameter) localObject5).getId());
		...
		while (((Iterator) localObject4).hasNext()) {
			...
			localObject5 = request.getParameter("attribute_"
					+ ((Attribute) localObject3).getId());
			if (StringUtils.isNotEmpty((String) localObject5))
				product.setAttributeValue((Attribute) localObject3,
						(String) localObject5);
			else
		...
		if ((specificationIds != null) && (specificationIds.length > 0)) {
			for (int i = 0; i < specificationIds.length; i++) {
				localObject6 = (Specification) this.specificationService
						.find(specificationIds[i]);
				localObject7 = request.getParameterValues("specification_"
						+ ((Specification) localObject6).getId());
				if ((localObject7 == null) || (localObject7.length <= 0))
					continue;
				for (int j = 0; j < localObject7.length; j++) {
					if (i == 0)
						if (j == 0) {
							BeanUtils.copyProperties(product, localObject1,
									new String[] { "id", "createDate",
											...
											"productNotifies" });
							((Product) localObject1)
									.setSpecifications(new HashSet());
							((Product) localObject1)
					...
					Product localProduct = (Product) ((List) localObject4)
							.get(j);
					SpecificationValue localSpecificationValue = (SpecificationValue) this.specificationValueService
							.find(Long.valueOf(localObject7[j]));
			...
			product.setSpecificationValues(null);
			BeanUtils
					.copyProperties(product, localObject1, new String[] { "id",
