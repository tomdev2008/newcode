...
public class MessageController extends BaseController {
	...
	public String send(Long draftMessageId, Model model) {
		net.shopxx.entity.Message localMessage = (net.shopxx.entity.Message) this.messageService
				.find(draftMessageId);
	...
	public String send(Long draftMessageId, String username, String title,
		...
		net.shopxx.entity.Message localMessage1 = (net.shopxx.entity.Message) this.messageService
				.find(draftMessageId);
