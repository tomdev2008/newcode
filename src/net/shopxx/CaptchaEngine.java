...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	private static final Font[] IIlIIIlI = { new Font("nyala", 1, 16),
	...
	private static final Color[] IIlIIIll = { new Color(255, 255, 255),
	...
	protected void buildInitialFactories() {
		RandomFontGenerator localRandomFontGenerator = new RandomFontGenerator(
				Integer.valueOf(12), Integer.valueOf(16), IIlIIIlI);
