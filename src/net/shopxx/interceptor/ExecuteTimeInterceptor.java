...
public class ExecuteTimeInterceptor extends HandlerInterceptorAdapter {
	private static final Logger IIIllIlI = LoggerFactory
			.getLogger(ExecuteTimeInterceptor.class);
	private static final String IIIllIll = ExecuteTimeInterceptor.class
			.getName() + ".START_TIME";
	...
	public void postHandle(HttpServletRequest request,
		...
		if (localLong1 == null) {
			...
			localLong1 = Long.valueOf(localLong2.longValue()
		...
		if (IIIllIlI.isDebugEnabled())
			IIIllIlI.debug("[" + handler + "] executeTime: " + localLong1
					+ "ms");
	}
}
