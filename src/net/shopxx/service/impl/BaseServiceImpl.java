...
public class BaseServiceImpl<T, ID extends Serializable> implements
	...
	public T update(T entity, String[] ignoreProperties) {
		...
		if (localObject != null) {
			IIIllIlI(entity, localObject,
					(String[]) ArrayUtils.addAll(ignoreProperties, IIIllIlI));
	...
	private void IIIllIlI(Object paramObject1, Object paramObject2,
		...
		PropertyDescriptor[] arrayOfPropertyDescriptor1 = BeanUtils
				.getPropertyDescriptors(paramObject2.getClass());
		Object localObject1 = paramArrayOfString != null ? Arrays
				.asList(paramArrayOfString) : null;
		for (PropertyDescriptor localPropertyDescriptor1 : arrayOfPropertyDescriptor1) {
			if ((localPropertyDescriptor1.getWriteMethod() == null)
					|| ((paramArrayOfString != null) && (localObject1
							.contains(localPropertyDescriptor1.getName()))))
				continue;
			PropertyDescriptor localPropertyDescriptor2 = BeanUtils
					.getPropertyDescriptor(paramObject1.getClass(),
							localPropertyDescriptor1.getName());
			if ((localPropertyDescriptor2 == null)
					|| (localPropertyDescriptor2.getReadMethod() == null))
				continue;
			try {
				Method localMethod = localPropertyDescriptor2.getReadMethod();
				if (!Modifier.isPublic(localMethod.getDeclaringClass()
						.getModifiers()))
					localMethod.setAccessible(true);
				Object localObject2 = localMethod.invoke(paramObject1,
						new Object[0]);
				Object localObject3 = localMethod.invoke(paramObject2,
						new Object[0]);
				Object localObject4;
