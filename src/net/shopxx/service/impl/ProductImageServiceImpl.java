...
public class ProductImageServiceImpl implements ProductImageService,
	...
	private void IIIllIlI(String paramString1, String paramString2, String paramString3, String paramString4, File paramFile, String paramString5)
  {
    try
    {
      this.taskExecutor.execute(new ProductImageServiceImpl.1(this, paramFile, paramString1, paramString5, paramString2, paramString3, paramString4));
    }
	...
	public void build(ProductImage productImage) {
		...
		if ((localMultipartFile != null) && (!localMultipartFile.isEmpty()))
			try {
				...
				String str1 = FreemarkerUtils.process(
				...
				Iterator localIterator = this.storagePlugins.iterator();
				while (localIterator.hasNext()) {
					...
					IIIllIlI(str3, str4, str5, str6, localFile,
