...
public abstract interface SearchService
{
  ...
  public abstract Page<Product> search(String paramString, BigDecimal paramBigDecimal1, BigDecimal paramBigDecimal2, ProductOrderType paramOrderType, Pageable paramPageable);
}
