...
public abstract class BaseDirective implements TemplateDirectiveModel {
	...
	protected boolean IIIllIlI(Environment paramEnvironment,
			Map<String, TemplateModel> paramMap) {
		Boolean localBoolean = (Boolean) FreemarkerUtils.getParameter(
				"useCache", Boolean.class, paramMap);
		return localBoolean != null ? localBoolean.booleanValue() : true;
	}

	protected String IIIllIll(Environment paramEnvironment,
			Map<String, TemplateModel> paramMap) {
	...
	protected List<Filter> IIIllIlI(Map<String, TemplateModel> paramMap,
		...
		for (PropertyDescriptor localPropertyDescriptor : arrayOfPropertyDescriptor1) {
			...
			if ((ArrayUtils.contains(paramArrayOfString, str))
				...
				continue;
			Object localObject = FreemarkerUtils.getParameter(str, localClass,
					paramMap);
	...
	protected List<Order> IIIllIlI(Map<String, TemplateModel> paramMap,
	...
	protected void IIIllIlI(String paramString, Object paramObject,
			Environment paramEnvironment,
			TemplateDirectiveBody paramTemplateDirectiveBody) {
		TemplateModel localTemplateModel = FreemarkerUtils.getVariable(
				paramString, paramEnvironment);
		...
		FreemarkerUtils.setVariable(paramString, localTemplateModel,
				paramEnvironment);
	}

	protected void IIIllIlI(Map<String, Object> paramMap,
			Environment paramEnvironment,
			TemplateDirectiveBody paramTemplateDirectiveBody) {
		...
		while (localIterator.hasNext()) {
			...
			TemplateModel localTemplateModel = FreemarkerUtils.getVariable(str,
					paramEnvironment);
