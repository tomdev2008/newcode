...
public class PromotionListDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Boolean localBoolean1 = (Boolean) FreemarkerUtils.getParameter(
				"hasBegun", Boolean.class, params);
		Boolean localBoolean2 = (Boolean) FreemarkerUtils.getParameter(
				"hasEnded", Boolean.class, params);
		...
		List localList1;
		if (bool)
			localList1 = this.IIIlllIl.findList(localBoolean1, localBoolean2,
					localInteger, localList2, localList3, str);
		else
			localList1 = this.IIIlllIl.findList(localBoolean1, localBoolean2,
					localInteger, localList2, localList3);
