...
public class PaginationDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		String str = (String) FreemarkerUtils.getParameter("pattern",
				String.class, params);
		Integer localInteger1 = (Integer) FreemarkerUtils.getParameter(
				"pageNumber", Integer.class, params);
		Integer localInteger2 = (Integer) FreemarkerUtils.getParameter(
				"totalPages", Integer.class, params);
		Integer localInteger3 = (Integer) FreemarkerUtils.getParameter(
