...
public class ProductCategoryChildrenListDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Long localLong = (Long) FreemarkerUtils.getParameter(
				"productCategoryId", Long.class, params);
		ProductCategory localProductCategory = (ProductCategory) this.IIIlllII
				.find(localLong);
		Object localObject;
		if ((localLong != null) && (localProductCategory == null)) {
			...
			if (bool)
				localObject = this.IIIlllII.findChildren(localProductCategory,
						localInteger, str);
			else
				localObject = this.IIIlllII.findChildren(localProductCategory,
						localInteger);
