...
public class ParameterGroupDaoImpl extends BaseDaoImpl<ParameterGroup, Long>
	...
	public ParameterGroup merge(ParameterGroup parameterGroup)
  {
    ...
    List localList1 = this.parameterDao.findList(parameterGroup, localHashSet);
    for (int i = 0; i < localList1.size(); i++)
    {
      ...
      List localList2 = this.entityManager.createQuery(str, Product.class).setFlushMode(FlushModeType.COMMIT).setParameter("parameter", localParameter).getResultList();
