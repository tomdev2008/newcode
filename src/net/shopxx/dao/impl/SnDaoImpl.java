...
public class SnDaoImpl implements SnDao, InitializingBean
{
  ...
  {
    this.IIIllIlI = new SnDaoImpl(this, SnType.product, this.snProductPrefix, this.snProductMaxLo);
    this.IIIllIll = new SnDaoImpl(this, SnType.order, this.snOrderPerfix, this.snOrderMaxLo);
    this.IIIlllII = new SnDaoImpl(this, SnType.payment, this.snPaymentPrefix, this.snPaymentMaxLo);
    this.IIIlllIl = new SnDaoImpl(this, SnType.refunds, this.snRefundsPrefix, this.snRefundsMaxLo);
    this.IIIllllI = new SnDaoImpl(this, SnType.shipping, this.snShippingPrefix, this.snShippingMaxLo);
    this.IIIlllll = new SnDaoImpl(this, SnType.returns, this.snReturnsPrefix, this.snReturnsMaxLo);
  }
