...
public class ReceiverDaoImpl extends BaseDaoImpl<Receiver, Long> implements
	...
	public Receiver findDefault(Member member) {
		...
		try {
			...
			return (Receiver) this.entityManager
	...
	public Page<Receiver> findPage(Member member, Pageable pageable) {
		CriteriaBuilder localCriteriaBuilder = this.entityManager
				.getCriteriaBuilder();
		CriteriaQuery<Receiver> localCriteriaQuery = localCriteriaBuilder
				.createQuery(Receiver.class);
		Root<Receiver> localRoot = localCriteriaQuery.from(Receiver.class);
