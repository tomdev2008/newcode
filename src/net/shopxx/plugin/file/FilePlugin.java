	...
	public List<FileInfo> browser(String path) {
		...
		if ((localFile1.exists()) && (localFile1.isDirectory()))
			for (File localFile2 : localFile1.listFiles()) {
				...
				localFileInfo.setUrl(localSetting.getSiteUrl() + path
						+ localFile2.getName());
				localFileInfo.setIsDirectory(Boolean.valueOf(localFile2
						.isDirectory()));
				localFileInfo.setSize(Long.valueOf(localFile2.length()));
				localFileInfo.setLastModified(new Date(localFile2
						.lastModified()));
