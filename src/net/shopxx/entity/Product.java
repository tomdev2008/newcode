...
public class Product extends BaseEntity {
	...
	static {
		try {
			...
			Element localElement = (Element) localDocument
					.selectSingleNode("/shopxx/template[@id='productContent']");
	...
	public Set<Promotion> getValidPromotions() {
		...
		TreeSet<Promotion> localTreeSet = new TreeSet<Promotion>();
	...
	public void preRemove() {
		...
		if (localSet != null) {
			...
			while (memberIterator.hasNext()) {
				...
				member.getFavoriteProducts().remove(this);
			}
		}
		Set<Promotion> promotionSet = getPromotions();
		Promotion promotion;
		if (promotionSet != null) {
			Iterator<Promotion> promotionItertator = promotionSet.iterator();
			while (promotionItertator.hasNext()) {
				promotion = promotionItertator.next();
		...
		if (orderItemSet != null) {
			Iterator<OrderItem> localIterator = orderItemSet.iterator();
			while (localIterator.hasNext()) {
